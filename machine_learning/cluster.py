...
#
    ...
    #raw_dir = r"C:\Users\magfa\Documents\Master\Masteroppgave\dataset_generation\dataset_3_test_set\raw"
    #label_dir = r"C:\Users\magfa\Documents\Master\Masteroppgave\dataset_generation\dataset_3_test_set\label"
#
#
    #dataset = SyntheticDataset(raw_dir, label_dir)
#
...
#
    #model = UNet()
    #checkpoint = torch.load(r"C:\Users\magfa\Documents\Master\Masteroppgave\machine_learning\weights\dataset_3_third_run_augmentations_100_epochs.pth", weights_only=True, map_location=torch.device('cpu'))
    #model.load_state_dict(checkpoint['model_state_dict'])
#
    #model_test(model, test_loader, save_folder_path = r"C:\Users\magfa\Documents\Master\Masteroppgave\machine_learning\predictions\dataset_3_third_run_augmentations_100_epochs")
