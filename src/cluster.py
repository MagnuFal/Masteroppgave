...
##
    #model = UNet()
    #sv_pt = r"/cluster/home/magnufal/Master/Masteroppgave/experiments/dataset_3_improved_resized_run_1/dataset_3_improved_resized_run_1.pth"
    ...
    #optimization_loop(model, save_path=sv_pt, tr_loader=train_loader, vl_loader=val_loader, weights=training_weights, epochs= 800, lr=10**-3)
