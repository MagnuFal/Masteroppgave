...
##
    model = UNet()
    sv_pt = r"/cluster/home/magnufal/Master/Masteroppgave/experiments/dataset_1_re_training_with_val_train_loss/dataset_1_re_training_with_val_train_loss_run_1.pth"
    ...
    optimization_loop(model, save_path=sv_pt, tr_loader=train_loader, vl_loader=val_loader, weights=None, epochs= 20, lr=10**-3)
...
#
    #model = UNet()
    #checkpoint = torch.load(r"/cluster/home/magnufal/Master/Masteroppgave/experiments/dataset_3_improved_resized_run_1/dataset_3_improved_resized_run_1.pth", weights_only=True, map_location=torch.device('cpu'))
    #model.load_state_dict(checkpoint['model_state_dict'])
#
    #model_test(model, test_loader, save_folder_path = r"/cluster/home/magnufal/Master/Masteroppgave/experiments/dataset_3_improved_resized_run_1/predictions_argmax")
#
